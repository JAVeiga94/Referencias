...
def abrir_aplicativo_principal():
    ...
    #def para atualizar os ietns de compras
    ...
    botao_comprar = tk.Button(aba5, text="Comprar Item", command=lambda: comprar_item_executar(lista_itens_aba5))
    botao_comprar.pack()
    ...
    #conf Treeview aba 5
    lista_itens_aba5 = ttk.Treeview(aba5, columns=('Nome', 'Preço', 'Quantidade', 'Marca'), show='headings')
    ...
    def gerar_pdf_relatorio_compras():
        try:
            ...
            c_pdf.drawImage('C:/Projetos/projeto[/build/exe.win-amd64-3.12/iave.jpeg', 40, 750, width=100, height=50)
            c_pdf.setFont("Helvetica-Bold", 16)
